                ...
                <v-layout row wrap mb-2>
                  <v-flex md8 offset-md2 xs12>
                    ...
                    <p>
                      ...
                      <br>
                      <br>
                      <b>&rarr;</b> Bagian ini terdiri dari 5 halaman dengan total 90 soal. Mohon diperhatikan sisa waktu yang berjalan ketika mengerjakan tes ini!
                    </p>
                  </v-flex>
                </v-layout>
...
export default {
        ...
        .then(res => {
          if (res.status == 200) {
            if (this.endRoute == "self") {
              ...
              this.$store.dispatch('setCurrentRoute', routeData)
              this.$router.replace({ name: 'self', params: { examId: this.$route.params.examId } })
            }
          }
        })
        .catch(e => {
  ...
  created () {
    ...
    this.axios.get(process.env.VUE_APP_API_URL + "/exam/type/7")
      .then(res => {
